...
class ReflectionFlowIntegrationTest extends AbstractIntegrationTest {
        ...
        void createPrivateReflection_thenUpdateAndDelete_shouldWorkCorrectly() throws Exception {
                ...
                mockMvc.perform(
                                ...
                                .andExpect(jsonPath("$.content")
                                                .value("This is an updated private reflection content."));
        ...
        @Test
        void createMultipleReflections_thenGetAccessibleReflections_shouldReturnAllCreatedReflections()
                        throws Exception {
                ...
                mockMvc.perform(
                                withJwtAuth(
                                                post("/api/reflections")
                                                                .contentType(MediaType.APPLICATION_JSON)
                                                                .content(objectMapper
                                                                                .writeValueAsString(publicRequest))))
                                .andExpect(status().isCreated());
                ...
                mockMvc.perform(
                                withJwtAuth(
                                                post("/api/reflections")
                                                                .contentType(MediaType.APPLICATION_JSON)
                                                                .content(objectMapper
                                                                                .writeValueAsString(privateRequest))))
                                .andExpect(status().isCreated());
                ...
                mockMvc.perform(
                                withJwtAuth(
                                                post("/api/reflections")
                                                                .contentType(MediaType.APPLICATION_JSON)
                                                                .content(objectMapper
                                                                                .writeValueAsString(householdRequest))))
                                .andExpect(status().isCreated());
        ...
        void updateReflection_fromPublicToPrivate_shouldUpdateVisibility() throws Exception {
                ...
                mockMvc.perform(
                                withJwtAuth(
                                                get("/api/reflections/my")))
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$[?(@.id == '" + reflectionId + "')].visibility")
                                                .value("PRIVATE"));
