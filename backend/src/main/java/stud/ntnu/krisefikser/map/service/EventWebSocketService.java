...
public class EventWebSocketService {
  ...
  /**
   * Broadcasts an update notification for an existing event.
   * Sends the updated event object to clients subscribed to the "/topic/events" destination.
   *
  ...
  /**
   * Broadcasts a creation notification for a new event.
   * Sends the newly created event object to clients subscribed to the "/topic/events/new" destination.
   *
  ...
  /**
   * Broadcasts a deletion notification for an event.
   * Sends the ID of the deleted event to clients subscribed to the "/topic/events/delete" destination.
   *
