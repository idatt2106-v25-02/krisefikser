 ...
 *
 * <p>This exception is associated with the HTTP 404 Not Found status code.
 * </p>
 */
...
public class ReflectionNotFoundException extends RuntimeException {
  ...
  /**
   * Constructs a new exception with a message indicating that a reflection with the specified ID
   * was not found.
   *
