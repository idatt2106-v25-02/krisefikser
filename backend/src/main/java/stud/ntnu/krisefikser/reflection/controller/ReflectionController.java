 ...
 *
 * <p>
 * The controller delegates business logic to the {@link ReflectionService}
 * component.
 * </p>
 *
...
public class ReflectionController {
         ...
         *
         * <p>
         * This endpoint allows authenticated users to create reflections with details
         * such as title,
         * content, and visibility settings. Each created reflection receives a unique
         * identifier.
         * </p>
         *
         * @param request the DTO containing the reflection details to be created. Must
         *                not be null
         *                and should contain valid data.
         * @return ResponseEntity containing the created reflection's details with HTTP
         *         status 201 (Created)
         */
        @PostMapping
         ...
         * current user's permissions. Public reflections are accessible to all users,
         * while
         * household and private reflections have restricted access.
         * </p>
         *
         * @param id the ID of the reflection to retrieve
         * @return ResponseEntity containing the requested reflection with HTTP status
         *         200 (OK)
         */
        @GetMapping("/{id}")
         ...
         *
         * <p>
         * Only the author or an admin can update a reflection. The updated details
         * include title, content, and visibility settings.
         * </p>
         *
         * @param id      the ID of the reflection to update
         * @param request the DTO containing the updated reflection details
         * @return ResponseEntity containing the updated reflection with HTTP status 200
         *         (OK)
         */
        @PutMapping("/{id}")
         ...
         * </p>
         *
         * @return ResponseEntity containing a list of accessible reflections with HTTP
         *         status 200 (OK)
         */
        @GetMapping
         ...
         *
         * @return ResponseEntity containing a list of the user's reflections with HTTP
         *         status 200 (OK)
         */
        @GetMapping("/my")
         ...
         *
         * @return ResponseEntity containing a list of public reflections with HTTP
         *         status 200 (OK)
         */
        @GetMapping("/public")
         ...
         *
         * @return ResponseEntity containing a list of reflections for the current
         *         user's household with HTTP status 200 (OK)
         */
        ...
        /**
         * Admin method to update any reflection in the system, regardless of
         * authorship.
         *
         * @param id      the ID of the reflection to update
         * @param request the DTO containing the updated reflection details
        ...
        /**
         * Admin method to delete any reflection in the system, regardless of
         * authorship.
         *
         * @param id the ID of the reflection to delete
         * @return ResponseEntity with HTTP status 204 (No Content)
