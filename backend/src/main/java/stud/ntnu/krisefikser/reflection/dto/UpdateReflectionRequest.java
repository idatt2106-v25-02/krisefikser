 ...
 *
 * <p>Contains fields that can be updated for a reflection, including title, content, and
 * visibility
 * settings. The household ID is optional and only relevant when visibility is set to HOUSEHOLD.
 * </p>
 */
@Data
@Builder
