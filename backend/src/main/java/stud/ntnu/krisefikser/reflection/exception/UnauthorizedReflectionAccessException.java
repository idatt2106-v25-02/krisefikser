...
/**
 * Exception thrown when a user attempts to access or modify a reflection they are not authorized to
 * access or modify.
 *
 * <p>This exception is associated with the HTTP 403 Forbidden status code.
 * </p>
 */
