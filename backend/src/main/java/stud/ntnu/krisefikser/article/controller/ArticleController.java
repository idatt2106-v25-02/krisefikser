...
/**
 * REST controller for managing articles in the system. Provides endpoints for
 * CRUD operations on
 * articles.
 *
 * @since 1.0
...
public class ArticleController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved articles", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = ArticleResponse.class))))
    })
    @GetMapping
    ...
    /**
     * Creates a new article in the system. Only accessible to users with ADMIN
     * role.
     *
    ...
    /**
     * Updates an existing article in the system. Only accessible to users with
     * ADMIN role.
     *
