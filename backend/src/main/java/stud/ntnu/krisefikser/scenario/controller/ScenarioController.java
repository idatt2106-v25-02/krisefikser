...
/**
 * REST controller for managing emergency scenarios within the crisis management
 * system.
 *
 * <p>
 * This controller provides endpoints for creating, retrieving, updating, and
 * deleting scenarios.
 * Scenarios are informational resources containing guidance for different types
 * of emergency situations.
 * Write operations (create, update, delete) are restricted to users with ADMIN
 * role, while read operations
...
public class ScenarioController {
        ...
        /**
         * Service component responsible for scenario operations. Handles creation,
         * retrieval, update, and
         ...
         *
         * <p>
         * This endpoint allows administrators to create scenarios with a title and
         * content.
         * Each created scenario receives a unique identifier.
         * </p>
         *
         * @param createRequest the DTO containing the scenario details to be created.
         *                      Must not be null
         *                      and should contain valid data.
         * @return ResponseEntity containing the created scenario's details with HTTP
         *         status 201 (Created)
         ...
         *
         * <p>
         * This endpoint allows administrators to update the title and content of an
         * existing scenario.
         * </p>
         *
         ...
         * @return ResponseEntity containing the updated scenario's details with HTTP
         *         status 200 (OK)
         ...
         *
         * <p>
         * This endpoint allows administrators to permanently remove a scenario from the
         * system.
         * </p>
         *
         ...
         *
         * <p>
         * This endpoint returns detailed information about a specific scenario,
         * including its title and content.
         * </p>
         *
         * @param id the unique identifier of the scenario to retrieve
         * @return ResponseEntity containing the scenario details with HTTP status 200
         *         (OK)
         * @throws EntityNotFoundException if no scenario with the specified ID exists
         * @see ScenarioResponse
         */
         ...
         *
         * <p>
         * This endpoint returns a list of all scenarios, including their titles and
         * content.
         * </p>
         *
         * @return ResponseEntity containing a list of all scenarios with HTTP status
         *         200 (OK)
         * @see ScenarioResponse
         */
        @GetMapping
