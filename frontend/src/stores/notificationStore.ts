...
export const useNotificationStore = defineStore('notification', () => {
  ...
  function addNotification(notification: BackendNotification) {
    console.log('[NotificationStore] Attempting to add notification:', JSON.parse(JSON.stringify(notification))); // DEBUG incoming notification
    ...
    if (!exists) {
      ...
      console.log('[NotificationStore] Notification added. Current count:', notifications.value.length);
