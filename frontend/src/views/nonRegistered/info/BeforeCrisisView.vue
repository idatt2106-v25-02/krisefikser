    ...
    return {
      ...
      quizQuestions: [
        ...
        },
        {
          ...
          correctAnswer: 2,
          explanation:
            'Myndighetene anbefaler at alle norske husstander bør være selvforsynte i minst syv døgn.',
        },
        {
          ...
          correctAnswer: 0,
          explanation:
            'NRK P1 er Norges offisielle beredskapskanal og vil sende viktig informasjon ved kriser.',
        },
        {
          ...
          correctAnswer: 2,
          explanation:
            'En beredskapsplan bør diskuteres med alle familiemedlemmer, inkludert barn på en aldersvennlig måte, og oppdateres årlig eller når familiesituasjonen endrer seg.',
        },
      ],
    }
  },
  ...
  >
    ...
    <ContentCard fullWidth>
      <div class="bg-blue-50 p-4 rounded-lg border border-blue-200 mb-4">
        ...
        <p class="text-gray-700">
          ...
          før en krisesituasjon. Du får umiddelbar tilbakemelding og kan lære mens du tester deg
          selv.
        </p>
        <a
          href="#quiz-section"
          class="inline-flex items-center text-blue-600 font-medium mt-2 hover:underline"
        >
          Gå til quiz
          <svg
      ...
      <p class="text-gray-700 mb-4">
        Å være forberedt før en krise inntreffer kan være avgjørende for hvordan du og dine nærmeste
        takler situasjonen. God beredskap handler om å ha tenkt gjennom mulige scenarier og ha
        nødvendige ressurser tilgjengelig.
      </p>
      <p class="text-gray-700 mb-4">
        Myndighetene anbefaler at alle norske husstander bør være selvforsynte i minst tre døgn. Det
        vil si at du bør ha tilstrekkelig med mat, vann, medisiner og andre nødvendigheter for å
        klare deg uten tilgang til strøm, vann eller butikker.
      </p>
    </ContentCard>
    ...
    <div class="grid md:grid-cols-2 gap-8 mb-8">
      ...
      <ContentCard title="Mat og vann" :iconComponent="iconComponents.Coffee" iconColor="blue">
        ...
        <p class="text-gray-700">
          Husk å tenke på spesielle behov i husstanden som babymat, allergier eller spesielle
          dietter. Sørg for at maten kan tilberedes uten strøm.
        </p>
      </ContentCard>

      <!-- Equipment and Supplies -->
      <ContentCard
        title="Utstyr og forsyninger"
        :iconComponent="iconComponents.Flashlight"
        iconColor="blue"
      >
        ...
        <p class="text-gray-700">
          Kontroller utstyret regelmessig for utløpsdato og funksjonalitet. Bytt ut batterier og
          forny mat og medisiner ved behov.
        </p>
      </ContentCard>
    </div>
    ...
    >
      ...
      <AlertBox type="info" :iconComponent="iconComponents.Info">
        Husk å oppdatere beredskapsplanen hvis familiesituasjonen endrer seg, og gå gjennom den med
        alle familiemedlemmer minst én gang i året.
      </AlertBox>
    </ContentCard>
    ...
    >
      ...
      <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
        <li class="flex items-start">
          ...
          <span
            ><strong>NRK P1</strong> er beredskapskanalen på radio (ha en batteridrevet radio) -
            <a
              href="https://radio.nrk.no/direkte/p1"
              target="_blank"
        ...
        <li class="flex items-start">
          <span class="inline-block mt-1 mr-2">•</span>
          <span
            >Nødnumre: <strong class="text-red-600">110</strong> (brann),
            <strong class="text-red-600">112</strong> (politi),
            <strong class="text-red-600">113</strong> (ambulanse),
            <strong class="text-blue-600">116 117</strong> (legevakt)</span
          >
        </li>
        <li class="flex items-start">
          <span class="inline-block mt-1 mr-2">•</span>
          <span
            >Last ned appen "Hjelp 113" for å kunne dele nøyaktig posisjon med nødetatene -
            <a
              href="https://www.hjelp113.no/"
              target="_blank"
              rel="noopener noreferrer"
              class="text-blue-600 hover:underline"
              >Hjelp113.no</a
        ...
        <li class="flex items-start">
          <span class="inline-block mt-1 mr-2">•</span>
          <span
            >Kriseinfo samler viktig informasjon under kriser -
            <a
      ...
      <AlertBox type="warning" :iconComponent="iconComponents.AlertTriangle">
        Vær kritisk til informasjon på sosiale medier. Stol på offisielle kanaler og informasjon fra
        myndighetene.
      </AlertBox>
    </ContentCard>
    <!-- Quiz section -->
    <ContentCard fullWidth id="quiz-section">
      <div class="bg-blue-50 p-6 rounded-lg mb-6">
        ...
        <p class="text-gray-700 mb-4">
          Svar på spørsmålene nedenfor for å teste din kunnskap om hva du bør gjøre før en
