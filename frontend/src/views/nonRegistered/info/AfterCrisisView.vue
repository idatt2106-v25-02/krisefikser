      ...
      quizQuestions: [
        {
          ...
          correctAnswer: 1,
          explanation:
            'Å dokumentere skader med bilder og notater er viktig for forsikringskrav og for å få nødvendig støtte til gjenoppbygging.',
        },
        {
          ...
          correctAnswer: 2,
          explanation:
            'Det er normalt å ha sterke følelsesmessige reaksjoner etter en krise. Å akseptere disse følelsene og gi seg selv tid til å bearbeide er en sunn tilnærming.',
        },
        {
          ...
          correctAnswer: 1,
          explanation:
            'Å evaluere dine erfaringer systematisk og bruke dette til å oppdatere beredskapsplanen er den mest effektive måten å forbedre fremtidig beredskap.',
        },
        {
          ...
          correctAnswer: 2,
          explanation:
            'Et sterkt lokalsamfunn kommer seg raskere etter en krise. Ved å delta i lokale dugnader og støtte naboer bidrar du til raskere normalisering for alle.',
        },
      ],
    }
  },
  ...
  >
    ...
    <ContentCard fullWidth>
      <div class="bg-green-50 p-4 rounded-lg border border-green-200 mb-4">
        ...
        <p class="text-gray-700">
          Denne siden inneholder en quiz nederst hvor du kan teste din kunnskap om hva du bør gjøre
          etter en krisesituasjon. Du får umiddelbar tilbakemelding og kan lære mens du tester deg
          selv.
        </p>
        <a
          href="#quiz-section"
          class="inline-flex items-center text-green-600 font-medium mt-2 hover:underline"
        >
          Gå til quiz
          <svg
      ...
      <p class="text-gray-700 mb-4">
        ...
        Hvordan du håndterer tiden etter en krise kan påvirke både din fysiske og mentale helse på
        lang sikt.
      </p>
      <p class="text-gray-700 mb-4">
        Denne siden gir deg veiledning om steg du bør ta etter en krise for å komme tilbake til
        hverdagen, evaluere dine erfaringer og forbedre din beredskap for fremtiden.
      </p>
    </ContentCard>
    ...
    <div class="grid md:grid-cols-2 gap-8 mb-8">
      ...
      <ContentCard
        ...
        :iconComponent="iconComponents.ClipboardCheck"
        iconColor="green"
      >
        <p class="text-gray-700 mb-4">Første steg etter at den akutte fasen er over:</p>
        <ul class="list-disc list-outside px-4 text-gray-700 mb-4 space-y-2">
          ...
          <li>
            <span
              >Kontakt forsikringsselskap hvis du har materielle skader -
              <a
                href="https://www.finansportalen.no/forsikring/"
                target="_blank"
                rel="noopener noreferrer"
                class="text-green-600 hover:underline"
                >Finansportalen</a
              >
              for forsikringsoversikt
            </span>
          </li>
          <li>Dokumenter eventuelle skader med bilder for forsikringsformål</li>
          <li>
            <span
              >Følg råd fra myndighetene via
              <a
                href="https://www.kriseinfo.no/"
                target="_blank"
                rel="noopener noreferrer"
                class="text-green-600 hover:underline"
                >Kriseinfo.no</a
              >
              og din kommunes nettsider
            </span>
          </li>
          <li>
            <span
              >Sjekk aktuelle støtteordninger hos
              <a
      ...
      <ContentCard
        title="Mental helse og restitusjon"
        :iconComponent="iconComponents.Heart"
        iconColor="green"
      >
        <p class="text-gray-700 mb-4">Psykologisk bearbeiding etter en krise er viktig:</p>
        <ul class="list-disc list-outside px-4 text-gray-700 mb-4 space-y-2">
          ...
          <li>
            <span
              >Vær oppmerksom på symptomer på posttraumatisk stress (PTSD) -
              <a
                href="https://www.helsenorge.no/psykisk-helse/reaksjoner-etter-kriser-og-katastrofer/"
                target="_blank"
                rel="noopener noreferrer"
                class="text-green-600 hover:underline"
                >Les mer på Helsenorge</a
              >
            </span>
          </li>
        ...
        <div class="bg-green-50 p-4 rounded-lg border border-green-200">
          ...
          <ul class="space-y-2">
            ...
            <li>
              <a
                href="https://helsenorge.no/psykisk-helse"
                target="_blank"
                rel="noopener noreferrer"
                class="text-green-600 hover:underline"
              >
    ...
    <ContentCard
      ...
      fullWidth
    >
      <p class="text-gray-700 mb-4">Et lokalsamfunn kommer raskere på fote når alle bidrar:</p>
      <ul class="list-disc list-outside px-4 text-gray-700 mb-4 space-y-2">
        <li>
          <span
            >Delta i lokale opprydningsaksjoner og dugnader - spør via kommunens nettsider eller
            lokale Facebook-grupper</span
          >
        </li>
        ...
        <li>
          <span
            >Delta i frivillig arbeid gjennom etablerte organisasjoner som
            <a
        ...
        <li>
          <span
            >Del dine erfaringer med
            <a
              href="https://www.dsb.no/rapporter-og-evalueringer/"
              target="_blank"
              rel="noopener noreferrer"
              class="text-green-600 hover:underline"
              >DSB</a
            >
            for å bidre til bedre krisehåndtering
          </span>
        </li>
      </ul>
      <p class="text-gray-700">
        Et sterkt lokalsamfunn er en av de beste beskyttelsene mot fremtidige kriser. Ved å bygge
        sosiale nettverk før en krise, står man bedre rustet til å komme seg gjennom den sammen.
      </p>
    </ContentCard>
    ...
    <ContentCard
      ...
      fullWidth
    >
      <p class="text-gray-700 mb-4">Hver krise gir verdifull erfaring for fremtiden:</p>
      <ul class="list-disc list-outside px-4 text-gray-700 mb-4 space-y-2">
        <li>Evaluer hvordan beredskapsplanen din fungerte</li>
        <li>
          <span
            >Noter hva som manglet i beredskapslageret -
            <a
              href="https://www.sikkerhverdag.no/din-beredskap/hendelser-og-kriser/"
              target="_blank"
              rel="noopener noreferrer"
              class="text-green-600 hover:underline"
              >Sjekk anbefalte forsyninger på Sikker Hverdag</a
            >
          </span>
        </li>
        ...
        <li>
          <span
            >Oppdater beredskapsplanen basert på erfaringene -
            <a
              href="https://www.dsb.no/egenberedskap/"
              target="_blank"
              rel="noopener noreferrer"
              class="text-green-600 hover:underline"
              >DSBs råd om egenberedskap</a
            >
          </span>
        </li>
        ...
        <li>
          <span
            >Revurder om det er nye ferdigheter du bør lære -
            <a
              href="https://www.rodekors.no/tilbudene/forstehjelp/"
              target="_blank"
              rel="noopener noreferrer"
              class="text-green-600 hover:underline"
              >Førstehjelpskurs hos Røde Kors</a
            >
          </span>
        </li>
      ...
      <div class="mt-4 bg-green-50 p-6 rounded-lg">
        ...
        <p class="text-gray-700 mb-3">Sett av tid til å reflektere over følgende spørsmål:</p>
    ...
    <ContentCard
      ...
      fullWidth
    >
      <p class="text-gray-700 mb-4">Gjenopprettelse av normalitet er viktig, men kan ta tid:</p>
      <ul class="list-disc list-outside px-4 text-gray-700 mb-4 space-y-2">
        ...
        <li>
          <span
            >Vær tålmodig med deg selv og andre - gjenoppbygging tar tid -
            <a
              href="https://www.psykologforeningen.no/publikum/videoer/videoer-om-psykisk-helse/resiliens-hvordan-takle-motgang"
              target="_blank"
              rel="noopener noreferrer"
              class="text-green-600 hover:underline"
              >Les om resiliens</a
      ...
      <p class="text-gray-700">
        Å komme tilbake til normalitet betyr ikke nødvendigvis å gå tilbake til akkurat slik livet
        var før. Mange opplever at prioriteringer og perspektiver endres etter en krise, noe som kan
        føre til positive endringer på lang sikt.
      </p>
      <div class="bg-green-50 p-4 rounded-lg border border-green-200 mt-4">
        ...
        <ul class="space-y-2">
          <li>
            <a
              href="https://www.nav.no/no/person/flere-tema/sosiale-tjenester/okonomisk-sosialhjelp"
              target="_blank"
              rel="noopener noreferrer"
              class="text-green-600 hover:underline"
            >
          ...
          <li>
            <a
              href="https://www.husbanken.no/om-husbanken/virkemidler/"
              target="_blank"
              rel="noopener noreferrer"
              class="text-green-600 hover:underline"
            >
    ...
    <ContentCard fullWidth id="quiz-section">
      <div class="bg-green-50 p-6 rounded-lg mb-6">
        ...
        <p class="text-gray-700 mb-4">
          Svar på spørsmålene nedenfor for å teste din kunnskap om hva du bør gjøre etter en
          krisesituasjon. Hver riktig besvarelse styrker din mentale beredskap.
        </p>
      </div>
