  ...
  <div class="bg-gray-50 min-h-screen py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <div class="bg-white p-8 rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
        ...
        <div class="grid md:grid-cols-3 gap-6">
          <div class="flex flex-col items-center text-center">
            ...
            <p class="text-gray-600">
              Planlegg beredskap sammen med din familie. Alle medlemmer kan se og bidra til beredskapslageret.
            </p>
          </div>
          ...
          <div class="flex flex-col items-center text-center">
            ...
            <p class="text-gray-600">
              Hold oversikt over mat, vann og forsyninger for hele husstanden. Få varslinger når varer nærmer seg utløpsdato.
            </p>
          </div>
          ...
          <div class="flex flex-col items-center text-center">
            ...
            <p class="text-gray-600">
              Definer møtesteder hvor familien skal samles i en krisesituasjon. Del kart og planer med alle husstandsmedlemmer.
            </p>
          </div>
        </div>
      </div>
