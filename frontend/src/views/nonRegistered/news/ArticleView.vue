  ...
  <div class="bg-gray-50 min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="flex items-center mb-6">
        <button class="text-blue-600 hover:text-blue-800 transition-colors font-medium flex items-center group" @click="goBackToNews">
    ...
    <div v-else-if="article" class="space-y-6">
      ...
      <div v-else-if="error" class="bg-white rounded-lg shadow-lg p-8 border-l-4 border-red-500">
        <div class="flex items-start">
          ...
          <div class="ml-3">
            ...
            <p class="mt-2 text-red-700">Beklager, men noe gikk galt. Vennligst prøv igjen senere.</p>
          </div>
        </div>
      </div>
      ...
      <div v-else-if="article" class="bg-white rounded-lg shadow-lg p-8 relative">
        ...
        <div class="relative z-10">
          <div class="inline-flex items-center px-2.5 py-0.5 rounded-full bg-blue-100 text-blue-800 text-sm mb-4">
      ...
      <div v-else class="bg-white rounded-lg shadow-lg p-8 flex flex-col items-center justify-center py-16">
        ...
        <p class="text-gray-600 text-center mb-6">Beklager, men artikkelen du leter etter eksisterer ikke.</p>
