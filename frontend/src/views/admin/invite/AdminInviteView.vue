      ...
      <Card class="w-full max-w-md border border-gray-200 shadow-sm">
        ...
        <CardContent>
              ...
              <div class="flex items-center">
                ...
                <div>
                  ...
                  <p class="text-sm text-green-600">
                    En invitasjon har blitt sendt til <span class="font-medium">{{ userEmail }}</span>.
                  </p>
                </div>
              </div>
            </div>
          ...
          <form v-else @submit="onSubmit" class="space-y-4">
            ...
            >
              <span v-if="!isLoading">Send invitasjon</span>
        ...
        <CardFooter class="flex justify-center">
          <Button variant="ghost" @click="goBack" class="text-sm text-gray-600 hover:text-gray-800">
