<template>
  <div class="container mx-auto p-4">
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-3xl font-bold">Husstandens Refleksjoner</h1>
      <Button variant="outline" @click="goBackToHousehold">
    ...
    <div v-if="householdReflections && householdReflections.length > 0" class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div 
    ...
    <div v-else-if="!isLoading && !error" class="text-center py-10">
      ...
      <h3 class="mt-2 text-sm font-medium text-gray-900">Ingen husstandsrefleksjoner</h3>
      <p class="mt-1 text-sm text-gray-500">Det ser ikke ut til å være noen refleksjoner delt med denne husstanden ennå.</p>
    </div>

    <!-- Delete Confirmation Dialog (optional, or handle via route navigation to detail view for actions) -->
  </div>
</template>
