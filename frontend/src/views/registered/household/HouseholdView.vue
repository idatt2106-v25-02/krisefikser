...
<template>
  <div class="bg-gray-50 min-h-screen">
    <div class="container mx-auto px-4 py-10">
      ...
      <div
        v-else-if="households && households.length > 0"
      ...
      >
        ...
        >
          ...
          <div
            :class="[
              'h-3',
              isActiveHousehold(household.id)
              ...
              <div class="flex items-start">
                ...
                <div class="flex flex-wrap gap-1">
                  ...
                  >
                    ...
                    }}{{ index < Math.min((household.members || []).length, 2) - 1 ? ',' : '' }}
                  </span>
      ...
      <div v-else class="text-center py-16 bg-white rounded-xl shadow mt-6">
        ...
        <p class="text-gray-600 mb-6">
          Du har ikke opprettet eller blitt lagt til i noen husstander ennå.
        </p>
        <router-link
          to="/husstand/opprett"
