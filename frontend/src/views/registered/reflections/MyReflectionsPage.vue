...
import { getEventById, useGetAllEvents } from '@/api/generated/event/event'
import type { EventResponse, ReflectionResponse } from '@/api/generated/model'
import { EventResponseStatus, ReflectionResponseVisibility } from '@/api/generated/model'
import { Button } from '@/components/ui/button'
import { BookOpen, Eye, PlusCircle, Search, Trash2 } from 'lucide-vue-next'
...
// Replace the confirmDeleteReflection function
...
<template>
  <div class="bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div
        v-else-if="reflections && reflections.length > 0"
      ...
      >
        ...
        >
          ...
          ></div>
          <div
            class="absolute top-0 right-0 w-16 h-16 rounded-bl-full -mt-1 -mr-1 overflow-hidden z-0 flex items-center justify-center"
            :class="{
          ...
          <div class="p-4 relative z-10 flex-grow flex flex-col">
            ...
            <div v-if="reflection.eventId" class="mb-2 text-sm text-gray-700">
              <span class="px-2 py-0.5 rounded-full bg-purple-100 text-purple-800 text-xs">
                <router-link :to="`/kriser/${reflection.eventId}`">{{
      ...
      <Dialog v-model:open="isEventSelectDialogOpen">
        <DialogContent class="sm:max-w-[600px]">
          ...
          <div
            v-else-if="filteredFinishedEventsForSelection.length === 0"
      ...
      <Dialog v-model:open="isReflectionFormDialogOpen">
        <DialogContent class="sm:max-w-[800px]">
          <DialogHeader>
            ...
            <DialogDescription> Skriv en refleksjon om hendelsen du valgte.</DialogDescription>
          </DialogHeader>
          <ReflectionForm
