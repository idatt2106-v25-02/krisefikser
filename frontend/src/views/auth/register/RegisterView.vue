  ...
  <div class="min-h-screen flex items-center justify-center bg-white py-12">
    ...
    >
      ...
      <FormField v-slot="{ componentField }" name="firstName">
        <FormItem>
          <FormLabel for="firstName" class="block text-sm font-medium text-gray-700 mb-1">
            Fornavn
          </FormLabel>
          <FormControl>
            <div class="relative">
      ...
      <FormField v-slot="{ componentField }" name="lastName">
        <FormItem>
          <FormLabel for="lastName" class="block text-sm font-medium text-gray-700 mb-1">
            Etternavn
          </FormLabel>
          <FormControl>
            <div class="relative">
      ...
      <FormField v-slot="{ componentField }" name="email">
        <FormItem>
          <FormLabel for="email" class="block text-sm font-medium text-gray-700 mb-1">
            E-post
          </FormLabel>
          <FormControl>
            <div class="relative">
          ...
          <div class="flex items-start space-x-2">
            <FormControl>
              <input
                ...
                :aria-checked="value"
                :checked="value"
                aria-labelledby="acceptedPrivacyPolicyText"
            ...
            <div class="text-sm text-gray-700">
              <span id="acceptedPrivacyPolicyText" class="cursor-pointer select-none">Jeg godtar</span>
              <router-link
